...
parameters.insideColor = '#ffccaa'
parameters.outsideColor = '#1b1b3a'
...
const spinAngle = Math.pow(radius, 1.3) * parameters.spin
...
positions[i3 + 1] = Math.pow(radius, 2) * -0.15 + randomY   // Pull downward
positions[i3 + 2] = Math.sin(branchAngle + spinAngle) * radius + randomZ


//tighten center for denser core
if (radius < 0.5) {
    positions[i3] *= 0.5
    positions[i3 + 2] *= 0.5
}
